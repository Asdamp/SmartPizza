...
/* TODO l'adapter è generato ogni volta che viene aperto. ed è hardcodato. bisogna passarglielo.*/
	...
	final AutoCompleteTextView input = new AutoCompleteTextView((Context) c);
	ArrayList<String> ing=Costanti.getDB().fetchIngredienti();
	 ArrayAdapter<String> adapter = new ArrayAdapter<String>((Context) c,
             android.R.layout.simple_dropdown_item_1line, 	ing);
